...
/** Contenuto preferenze — riusato dalla route /impostazioni/preferenze e dal pannello Account desktop/tablet. */
export function PreferenzeContent({ hideHeader }: { hideHeader?: boolean }) {
