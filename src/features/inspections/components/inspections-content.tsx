...
import { useInspectionsByHive, useDeleteInspection, type InspectionListItem } from '../hooks/use-inspections'
import { PATHOLOGY_LABELS } from '../constants'
...
/** Elenco ispezioni di un'arnia — riusato dalla route /hives/$hiveId/inspections e dal pannello Home desktop/tablet. */
export function InspectionsContent({ hiveId, hideHeader }: { hiveId: string; hideHeader?: boolean }) {
