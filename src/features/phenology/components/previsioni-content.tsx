...
/** Contenuto previsioni fioriture — riusato dalla route /previsioni e dal pannello "Più" desktop/tablet. */
export function PrevisioniContent({ hideHeader }: { hideHeader?: boolean }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 tablet:px-8">
        {hideHeader && (
        ...
        {/* Risultato — sotto al form, sempre su una colonna */}
        <div className="mt-4">
          {!(forecastLat != null && selectedPrediction && selectedSpecies) && (
            <p className="text-sm text-wood-400">Seleziona apiario e pianta per vedere la previsione</p>
          )}

          {/* Prediction result */}
          {forecastLat != null && selectedPrediction && selectedSpecies && (
            <div className="bg-cream-100 border border-cream-200 rounded-xl p-4 flex flex-col gap-3">
              {/* Phase badge */}
          ...
          {forecastLat != null && selectedPrediction && selectedSpecies && (
            <button
              ...
              className="w-full mt-4 text-sm bg-cream-100 border border-dashed border-cream-300 rounded-xl py-3 text-wood-600 hover:bg-cream-200 hover:border-wood-300 transition-colors"
            >
