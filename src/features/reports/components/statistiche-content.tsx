...
import { ApiaryReportSection } from './apiary-report-section'
...
/** Contenuto statistiche — riusato dalla route /statistiche e dal pannello "Più" desktop/tablet. */
export function StatisticheContent({ hideHeader }: { hideHeader?: boolean }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 px-4 py-6 overflow-y-auto">
        <div className="max-w-lg tablet:max-w-3xl mx-auto">

          {/* ── Colonna sinistra: dati + engagement ── */}
            ...
            {isAdmin && weeklyData.length > 0 && (
              <section>
                ...
                <div className="rounded-lg bg-cream-100 px-4 pt-4 pb-3">
                  <div className="flex items-end gap-1.5 h-24 xl:h-40">
                    {weeklyData.map((w, i) => (
          ...
          {/* ── Colonna destra: report PDF + storage + costi ── */}
