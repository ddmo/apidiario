...
describe('generateSuggestions', () => {
  ...
  it('returns suggestion when queen not seen', () => {
    const INSP = {
      ...
      notes: null, has_queen_cells: false, queen_cells_removed: [], queen_cells_remaining: [],
  ...
  it('orders critical before warning before info', () => {
    const INSP = {
      ...
      notes: null, has_queen_cells: true, queen_cells_removed: ['dry_cup'], queen_cells_remaining: [], pollen_importation: null,
      behavior: null, pathologies: ['varroa'] as any,
